    ...
    <section id="kontakt" className="relative py-20 md:py-32 bg-slate-950 text-slate-300 border-t border-slate-900 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 max-w-6xl">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 text-center lg:text-left space-y-8 lg:sticky lg:top-24">
            ...
            <div className="relative p-6 sm:p-8 bg-slate-900/60 border border-slate-800 rounded-3xl mt-4 max-w-2xl mx-auto lg:mx-0 shadow-inner group">
          ...
          <div className="lg:col-span-7 relative group mt-4 lg:mt-0">
            ...
            <div className="bg-slate-900 border border-slate-700/50 rounded-[2rem] p-6 sm:p-10 md:p-12 relative overflow-hidden shadow-2xl backdrop-blur-sm">
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex items-center gap-3 mb-8 sm:mb-10 justify-center sm:justify-start">
                  <div className="p-2.5 bg-blue-500/10 border border-blue-500/20 rounded-xl hidden sm:block">
                    <ShieldCheck className="w-6 h-6 text-blue-400" />
                  </div>
                  <h3 className="text-white font-bold text-xl sm:text-2xl text-center sm:text-left">
                ...
                <div className="space-y-4 sm:space-y-5 mb-10 sm:mb-12">
                  {cta.bullets.map((item, idx) => (
                    <div 
                      key={idx} 
                      className="flex gap-4 sm:gap-5 items-start bg-slate-950/60 border border-slate-800/80 p-5 sm:p-6 rounded-[1.5rem] hover:border-blue-500/40 transition-colors shadow-sm group/item"
                    >
                      ...
                      <div>
                        <h4 className="font-bold text-white text-base sm:text-lg mb-1.5 leading-snug">
                          {item.title}
                        </h4>
                ...
                <div className="mt-auto pt-4 border-t border-slate-800/60">
                  <div className="flex flex-col items-center">
                    ...
                    >
                      ...
                      <Button 
                        size="lg" 
                        className="relative w-full h-auto min-h-[3.5rem] sm:min-h-[4.5rem] py-4 text-[16px] sm:text-[17px] xl:text-[21px] font-extrabold tracking-tight bg-blue-600 hover:bg-blue-500 text-white rounded-2xl shadow-xl transition-all flex flex-row items-center justify-center gap-2 xl:gap-4 border border-blue-400/30 px-3 xl:px-8"
                      >
