...
export function ApplicationForm({
  ...
  application: QualificationContent
}) {
  ...
  const current = application.steps[step]
  const answered = Boolean(answers[current.key])
  const allAnswered = application.steps.every((s) => answers[s.key])
  ...
  const rejected =
    allAnswered &&
    (answers.timeline === "rozeznanie" || answers.budget === "ponizej")
