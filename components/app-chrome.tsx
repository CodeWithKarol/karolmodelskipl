...
const FUNNEL_PATHS = ["/projektowanie-mvp", "/aplikuj"]
    ...
    <footer className="relative border-t border-slate-800/60 bg-slate-950 py-12 text-slate-400 sm:py-16">
      <div className="container mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr] md:gap-12">
          <div>
            ...
            <p className="mt-3 max-w-xl text-sm leading-relaxed text-slate-400 sm:text-[15px]">
              Projektuję i wdrażam stabilne systemy internetowe w standardach bankowych (Citibank, BNP Paribas).
              Zastępuję agencje programistyczne bezpośrednią współpracą inżynierską — od pomysłu do działającego kodu w 30 dni.
            </p>
          </div>
        ...
        <div className="mt-10 flex flex-col gap-2 border-t border-slate-800/60 pt-6 sm:mt-12 sm:flex-row sm:items-center sm:justify-between">
          ...
          <p className="text-[11px] uppercase tracking-wider text-slate-600 sm:text-xs">B2B / SaaS · Bankowe standardy · 30 dni</p>
        </div>
      </div>
    </footer>
  )
