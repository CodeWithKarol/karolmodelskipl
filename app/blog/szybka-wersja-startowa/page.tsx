          ...
          <div className="hidden w-full max-w-md lg:max-w-sm flex-shrink-0 lg:block lg:mt-8">
            <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-5 shadow-2xl backdrop-blur-xl">
              ...
              <ul className="space-y-1.5 mb-4">
                <li className="text-xs text-slate-300 leading-snug">🚀 Start w 30 dni: jak skupić się na najważniejszej funkcji i szybko wyjść do klientów.</li>
                <li className="text-xs text-slate-300 leading-snug">🛡️ Ochrona budżetu: dlaczego nie warto inwestować w zbędne dodatki przed weryfikacją pomysłu przez rynek.</li>
                <li className="text-xs text-slate-300 leading-snug">📈 Testowanie pomysłów: jak sprawdzić, czy Twój biznes cyfrowy ma szansę na sukces i generowanie zysków.</li>
                <li className="text-xs text-slate-300 leading-snug">🗺️ Osobista Mapa Drogowa IT: najkrótsza ścieżka wejścia na rynek dopasowana do Twojego budżetu.</li>
              </ul>
