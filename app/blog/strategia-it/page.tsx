...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: "Zastanawiasz się, jak mądrze zarządzać technologią w firmie, jak weryfikować wyceny agencji i dlaczego tradycyjny model software house'ów to pułapka?",
    alternates: {
...
export default function StrategiaItCategoryPage() {
  const posts = getAllPosts().filter((p) => p.silo === "Strategia i Niezależne Partnerstwo Technologiczne")
    ...
    "@graph": [
      {
        ...
        description: "Praktyczne poradniki o zarządzaniu IT na szczeblu zarządczym, oparte na rygorystycznych standardach bankowych.",
      },
    ],
  }
        ...
        <div className="relative z-10 flex-1 container mx-auto px-4 flex flex-col lg:flex-row items-center lg:items-start justify-start lg:justify-center gap-6 lg:gap-20">
          ...
          <div className="flex-1 w-full max-w-2xl text-left pt-4 sm:pt-8">
            ...
            <p className="text-base sm:text-lg text-slate-400 mb-5 sm:mb-8 leading-relaxed max-w-xl">
              Zastanawiasz się, jak mądrze zarządzać technologią w firmie, weryfikować wyceny zewnętrznych dostawców i dlaczego tradycyjny model software house'ów często prowadzi do przepalania budżetu? Znajdziesz tu praktyczne poradniki o tworzeniu strategii IT, doradztwie technicznym oraz kontroli oprogramowania na szczeblu zarządczym – w oparciu o rygorystyczne standardy bankowe.
            </p>
      ...
      <main className="container mx-auto max-w-7xl px-4 py-12 sm:py-24">
        <div className="mb-8 sm:mb-12 text-center">
          ...
          <p className="max-w-2xl mx-auto text-slate-400 font-light leading-relaxed text-xs sm:text-base">
            Wybierz interesujący Cię temat i dowiedz się, jak świadomie zarządzać technologią w biznesie.
          </p>
        </div>
