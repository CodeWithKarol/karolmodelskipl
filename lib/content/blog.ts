export const blogContent = {
  metadata: {
    title: "Baza wiedzy o oprogramowaniu dla firm | Praktyczne poradniki IT",
    description:
    ...
    benefits: [
      {
        ...
        desc: "Przeanalizujemy aktualne wyzwania i cele Twojego biznesu.",
      },
      {
        title: "Indywidualny Plan Wdrożenia lub Modernizacji w 30 dni",
        desc: "Otrzymasz najszybszą ścieżkę optymalizacji systemów.",
      },
      {
