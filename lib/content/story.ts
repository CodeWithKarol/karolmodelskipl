...
export const story = {
  ...
  intro:
    "Większość właścicieli firm po kontakcie z tradycyjnym oprogramowaniem stworzonym przez dużą agencję ma to samo poczucie: <em>„To jest droższe, wolniejsze i bardziej skomplikowane, niż miało być”</em>.",
  context:
    "Tradycyjny model agencji nastawiony jest na sprzedaż <em>samotnego procesu</em>, a nie Twojego sukcesu biznesowego:",
  points: [
    {
